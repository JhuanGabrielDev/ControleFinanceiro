...
?>
<nav class="nav-bar-default navbar-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
            ...
            <li>
                <a href="#"><i class="fa fa-sort fa-3x"></i>Movimento<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
            ...
            <li>
                <a href="login.php?close=1"><i class="fa fa-sign-out fa-3x"></i>Sair</a>
            </li>
        </ul>
